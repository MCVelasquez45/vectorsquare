...
const Chat = () => {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 text-black dark:text-white p-6 rounded-lg shadow-lg max-w-lg mx-auto">
            <div className="mb-4">
            ...
            <div className="flex items-center gap-4">
                ...
                <input
                    ...
                    className="flex-1 p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:border-yellow-500"
                />
                <motion.button
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.9 }}
